  ...
  const ChatComponent = () => {
    ...
    const ChatItem = ({ item, index }) => {
      ...
      return (
        <li
          ref={containerRef}
          className="relative p-2 border-b-gray-300 border-b-[2px] hover:bg-gray-100 group m-0 basis-[55px] flex items-center"
        >
          <span>{item}</span>
          {/* Градиентен overlay при hover */}
          <span
    ...
    return (
      <main className="flex items-center pt-12 min-h-[100vh]">
        <div className="flex w-[80%] h-[80vh] m-auto gap-7 items-stretched flex-wrap">
          ...
          {/* Дясна секция */}
          <div className="flex-[2] bg-white rounded-2xl">
